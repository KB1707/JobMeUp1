document.addEventListener("DOMContentLoaded", function () {
  const questions = [
    {
      question:
        "If a car travels at a speed of 60 miles per hour how far will it travel in 2.5 hours?",
      options: [
        "A. 125 miles",
        "B. 150 miles",
        "C. 175 miles",
    ...
    {
      question:
        "If a rectangular garden measures 12 meters in length and 8 meters in width, what is the area of the garden?",
    ...
    {
      question:
        "If 30% of the students in a class are girls, and there are 24 boys, how many students are in the class in total?",
    ...
    {
      question:
        "A store sells a product for $20, and the cost to produce each unit is $12. What is the store's profit per unit?",
    ...
    {
      question:
        " A box contains 24 red balls, 36 blue balls, and 40 green balls. What is the probability of selecting a blue ball randomly?",
  ...
  function showScore() {
    ...
    document.getElementById("submit-btn-3").style.display = "none"; // Hide the submit button
  }

  document.getElementById("start-btn-3").addEventListener("click", () => {
    document.getElementById("start-btn-3").style.display = "none";
    document.getElementById("prev-btn-3").style.display = "inline-block"; // Show the prev button
    document.getElementById("next-btn-3").style.display = "inline-block"; // Show the next button
    createQuestion(questions[currentQuestionIndex], currentQuestionIndex);
  });
